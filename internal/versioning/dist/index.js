...
async function hasActionFile(dir) {
    try {
        ...
        (0, core_1.error)(`Failed to read directory ${dir}: ${error}`);
        return false;
    }
}
async function isActionDirectory(filePath, retries = 0) {
    (0, core_1.debug)(`Checking if ${filePath} is an action directory...`);
    if (retries >= 5) {
        (0, core_1.debug)(`Reached maximum retries: ${retries}`);
        return null;
    }
    try {
        ...
        if (dir === 'internal/versioning' || dir.endsWith('/internal/versioning')) {
            (0, core_1.debug)(`Skipping internal versioning directory: ${dir}`);
            return null;
        }
        ...
        if (dir === '.' || dir === '/') {
            (0, core_1.debug)(`Reached root directory: ${dir}`);
            return null;
        }
        ...
        (0, core_1.warning)(`Failed to check for action files: ${error.message}`);
        return null;
    }
}
...
async function run() {
    try {
        ...
        const runForAll = (0, core_1.getInput)('runForAll').toLowerCase() === 'true';
        const dryRun = (0, core_1.getInput)('dryRun').toLowerCase() === 'true';
        const _package = (0, core_1.getInput)('package');
        const octokit = github.getOctokit(token);
        const context = github.context;
        (0, core_1.info)(`Event name: ${context.eventName}`);
        (0, core_1.info)(`SHA: ${context.sha}`);
        (0, core_1.info)(`runForAll: ${runForAll}`);
        (0, core_1.info)(`dryRun: ${dryRun}`);
        let files = [];
        if (_package && runForAll) {
            (0, core_1.warning)(`'runForAll' is enabled, but package is specified. Please specify a package or disable 'runForAll'.`);
            (0, core_1.setOutput)('versioned-actions', '[]');
            return;
        }
        if (_package) {
            for (const ext of ['yaml', 'yml']) {
                const packagePath = node_path_1.default.join(_package, `action.${ext}`);
                if ((0, node_fs_1.existsSync)(packagePath)) {
                    (0, core_1.info)(`Running for package "${_package}"`);
                    files = [packagePath];
                    break;
                }
            }
            if (!files.length) {
                (0, core_1.warning)(`Package "${_package}" not found`);
                (0, core_1.setOutput)('versioned-actions', '[]');
                return;
            }
        }
        else if (runForAll) {
            (0, core_1.info)('Run for all enabled, getting all action files');
        ...
        for (const file of files) {
            ...
            if (actionDir !== null && !modifiedActions.has(actionDir)) {
                (0, core_1.info)(`Found action directory: ${actionDir}`);
                modifiedActions.add(actionDir);
            }
        }
        if (modifiedActions.size === 0) {
            (0, core_1.info)('No actions were modified in this merge.');
            (0, core_1.setOutput)('versioned-actions', '[]');
            return;
        }
...
var identity = __nccwpck_require__(1891);
var Scalar = __nccwpck_require__(4305);
var YAMLMap = __nccwpck_require__(2938);
var YAMLSeq = __nccwpck_require__(3571);
var resolveBlockMap = __nccwpck_require__(619);
var resolveBlockSeq = __nccwpck_require__(1610);
var resolveFlowCollection = __nccwpck_require__(562);
...
var Document = __nccwpck_require__(7977);
var composeNode = __nccwpck_require__(413);
var resolveEnd = __nccwpck_require__(2368);
var resolveProps = __nccwpck_require__(6715);
...
var Alias = __nccwpck_require__(5525);
var identity = __nccwpck_require__(1891);
var composeCollection = __nccwpck_require__(6745);
var composeScalar = __nccwpck_require__(1337);
var resolveEnd = __nccwpck_require__(2368);
var utilEmptyScalarPosition = __nccwpck_require__(6827);
...
var identity = __nccwpck_require__(1891);
var Scalar = __nccwpck_require__(4305);
var resolveBlockScalar = __nccwpck_require__(293);
var resolveFlowScalar = __nccwpck_require__(7686);
...
var directives = __nccwpck_require__(9082);
var Document = __nccwpck_require__(7977);
var errors = __nccwpck_require__(7460);
var identity = __nccwpck_require__(1891);
var composeDoc = __nccwpck_require__(6183);
var resolveEnd = __nccwpck_require__(2368);
...
var Pair = __nccwpck_require__(5153);
var YAMLMap = __nccwpck_require__(2938);
var resolveProps = __nccwpck_require__(6715);
var utilContainsNewline = __nccwpck_require__(3151);
var utilFlowIndentCheck = __nccwpck_require__(7319);
var utilMapIncludes = __nccwpck_require__(8279);
...
var Alias = __nccwpck_require__(5525);
var Collection = __nccwpck_require__(1633);
var identity = __nccwpck_require__(1891);
var Pair = __nccwpck_require__(5153);
var toJS = __nccwpck_require__(3119);
var Schema = __nccwpck_require__(1148);
var stringifyDocument = __nccwpck_require__(8577);
var anchors = __nccwpck_require__(7048);
var applyReviver = __nccwpck_require__(7817);
var createNode = __nccwpck_require__(7616);
var directives = __nccwpck_require__(9082);
...
var identity = __nccwpck_require__(1891);
var visit = __nccwpck_require__(1360);
...
var YAMLMap = __nccwpck_require__(2938);
var YAMLSeq = __nccwpck_require__(3571);
var cst = __nccwpck_require__(3921);
var lexer = __nccwpck_require__(1893);
var lineCounter = __nccwpck_require__(2808);
var parser = __nccwpck_require__(3124);
var publicApi = __nccwpck_require__(4563);
var visit = __nccwpck_require__(1360);
...
var visit = __nccwpck_require__(1360);
var identity = __nccwpck_require__(1891);
var Node = __nccwpck_require__(5605);
var toJS = __nccwpck_require__(3119);
...
var createNode = __nccwpck_require__(7616);
var stringifyPair = __nccwpck_require__(9392);
var addPairToJSMap = __nccwpck_require__(1308);
var identity = __nccwpck_require__(1891);
...
var stringifyCollection = __nccwpck_require__(3008);
var addPairToJSMap = __nccwpck_require__(1308);
var Collection = __nccwpck_require__(1633);
var identity = __nccwpck_require__(1891);
var Pair = __nccwpck_require__(5153);
...
var log = __nccwpck_require__(6669);
var merge = __nccwpck_require__(4376);
var stringify = __nccwpck_require__(3376);
var identity = __nccwpck_require__(1891);
var toJS = __nccwpck_require__(3119);
...
var resolveFlowScalar = __nccwpck_require__(7686);
var errors = __nccwpck_require__(7460);
var stringifyString = __nccwpck_require__(3665);
...
var cstScalar = __nccwpck_require__(6242);
var cstStringify = __nccwpck_require__(2393);
var cstVisit = __nccwpck_require__(5207);
...
var identity = __nccwpck_require__(1891);
var map = __nccwpck_require__(1231);
var seq = __nccwpck_require__(814);
var string = __nccwpck_require__(3724);
var tags = __nccwpck_require__(8478);
...
var Scalar = __nccwpck_require__(4305);
var stringifyNumber = __nccwpck_require__(3677);
...
var map = __nccwpck_require__(1231);
var _null = __nccwpck_require__(5940);
var seq = __nccwpck_require__(814);
var string = __nccwpck_require__(3724);
var bool = __nccwpck_require__(5579);
var float = __nccwpck_require__(1433);
var int = __nccwpck_require__(2790);
...
var float = __nccwpck_require__(1433);
var int = __nccwpck_require__(2790);
var schema = __nccwpck_require__(9772);
var schema$1 = __nccwpck_require__(7331);
var binary = __nccwpck_require__(743);
var merge = __nccwpck_require__(4376);
var omap = __nccwpck_require__(6683);
var pairs = __nccwpck_require__(7221);
var schema$2 = __nccwpck_require__(5762);
var set = __nccwpck_require__(5340);
var timestamp = __nccwpck_require__(3932);
...
var string = __nccwpck_require__(3724);
var binary = __nccwpck_require__(743);
var bool = __nccwpck_require__(8514);
var float = __nccwpck_require__(2026);
var int = __nccwpck_require__(7149);
var merge = __nccwpck_require__(4376);
var omap = __nccwpck_require__(6683);
var pairs = __nccwpck_require__(7221);
var set = __nccwpck_require__(5340);
...
var anchors = __nccwpck_require__(7048);
var identity = __nccwpck_require__(1891);
var stringifyComment = __nccwpck_require__(2875);
var stringifyString = __nccwpck_require__(3665);
...
var Scalar = __nccwpck_require__(4305);
var foldFlowLines = __nccwpck_require__(6767);
