...
const HEADERS: Record<ArbiterDecision['outcome'], string> = {
  approve: '## Ladon verdict: Approve',
  'request-changes': '## Ladon verdict: Request changes',
  comment: '## Ladon verdict: Comment (human reviewer recommended)',
  escalate: '## Ladon verdict: Escalate to human review',
}
