...
Some repos declare **hard governance/approval gates** in LADON.md — a fact like
"this file/directory/changeset type always requires human or CODEOWNERS
sign-off" or "this LADON.md section can't be edited without Escalation
...
- **Why this rule exists:** before this rule, the reviewer re-derived "this
  file is under a hard approval gate" from LADON.md prose on every single
